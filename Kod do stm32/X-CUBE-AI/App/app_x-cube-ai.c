...
AI_ALIGNED(32)
static uint8_t pool0[AI_ML_NETWORK_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_ML_NETWORK_MODEL_NAME,
        .config = AI_ML_NETWORK_DATA_CONFIG,
        .ai_get_report = ai_ml_network_get_report,
        .ai_create = ai_ml_network_create,
        .ai_destroy = ai_ml_network_destroy,
        .ai_get_error = ai_ml_network_get_error,
        .ai_init = ai_ml_network_init,
        .ai_run = ai_ml_network_run,
        .ai_forward = ai_ml_network_forward,
        .ai_data_params_get = ai_ml_network_data_params_get,
