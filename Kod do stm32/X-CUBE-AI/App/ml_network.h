/**
  ...
  ******************************************************************************
  */
#ifndef AI_ML_NETWORK_H
#define AI_ML_NETWORK_H

#include "ml_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ML_NETWORK_MODEL_NAME          "ml_network"
#define AI_ML_NETWORK_ORIGIN_MODEL_NAME   "animal_sound_model_dynamic"

/******************************************************************************/
#define AI_ML_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ML_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ML_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ML_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_ML_NETWORK_IN \
  ai_ml_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ML_NETWORK_IN_SIZE { \
  AI_ML_NETWORK_IN_1_SIZE, \
}
#define AI_ML_NETWORK_IN_SIZE_BYTES { \
  AI_ML_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_ML_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ML_NETWORK_IN_1_CHANNEL     (80)
#define AI_ML_NETWORK_IN_1_SIZE        (80)
#define AI_ML_NETWORK_IN_1_SIZE_BYTES  (320)

/******************************************************************************/
#define AI_ML_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ML_NETWORK_OUT \
  ai_ml_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ML_NETWORK_OUT_SIZE { \
  AI_ML_NETWORK_OUT_1_SIZE, \
}
#define AI_ML_NETWORK_OUT_SIZE_BYTES { \
  AI_ML_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_ML_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_ML_NETWORK_OUT_1_CHANNEL     (10)
#define AI_ML_NETWORK_OUT_1_SIZE        (10)
#define AI_ML_NETWORK_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_ML_NETWORK_N_NODES (8)
 ...
 * @ref ai_ml_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_ml_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ml_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ml_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ML_NETWORK_*
 * defines into file @ref ml_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_ml_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ML_NETWORK_H */
